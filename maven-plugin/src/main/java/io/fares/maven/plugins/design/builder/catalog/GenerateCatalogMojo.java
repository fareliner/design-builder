...
@Mojo(name = "catalog", defaultPhase = LifecyclePhase.GENERATE_RESOURCES, threadSafe = true, requiresDependencyResolution = ResolutionScope.NONE)
public class GenerateCatalogMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            Element decDef = doc.createElementNS(
                    "urn:oasis:names:tc:entity:xmlns:xml:catalog", "system");
            decDef.setAttribute("systemId",
                    "http://www.oasis-open.org/committees/entity/release/1.1/catalog.dtd");
            decDef.setAttribute("uri",
                    "resource:org/apache/xml/resolver/etc/catalog.dtd");
            ...
            if (getLog().isInfoEnabled()) {
                getLog().info(
                        "Write catalog to "
                                + targetCatalogFile.getAbsoluteFile().toURI()
                                .toString());
            }
