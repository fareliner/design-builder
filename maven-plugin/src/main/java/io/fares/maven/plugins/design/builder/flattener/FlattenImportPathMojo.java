...
@Mojo(name = "flatten", defaultPhase = LifecyclePhase.GENERATE_SOURCES, threadSafe = true, requiresDependencyCollection = ResolutionScope.COMPILE, requiresDependencyResolution = ResolutionScope.COMPILE, requiresProject = true)
public class FlattenImportPathMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (getLog().isDebugEnabled() || verbose)
            getLog().info(
                    "Flattened schemata will be placed in "
                            + outputDirectory.toString());
        ...
        try {
            ...
            CatalogFileScanner catscanner = catalogFileScannerFactory.newInstance(project, repositorySystemSession, remoteRepositories, resources, catalogs, sourceDirectory, includes, excludes);
            ...
            if (sourceDirectory == null && flattenTarget == null) {
                ...
                throw new MojoExecutionException(
                        "Neither sourceDirectory nor flattenTarget provided.");
            ...
            if (artifacts.size() == 0) {
                getLog().warn(
                        "No resources for catalog file found in "
            ...
            throw new MojoExecutionException(
                    "Failed to resolve catalog files.", e);
        } catch (Throwable e) {
            throw new MojoExecutionException("Some other failure occured.", e);
        }
    ...
    /**
     * Setup a <code>XMLCatalogResolver</code> to be sued for the flattening
     * engine.
     *
