...
public abstract class FileByFileCatalogWriter extends AbstractCatalogWriter {

  FileByFileCatalogWriter() throws ParserConfigurationException {
  }

  FileByFileCatalogWriter(URI catalogLocation) throws ParserConfigurationException {
